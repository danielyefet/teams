...
function Meme({ query }) {
  ...
  const image = `https://res.cloudinary.com/teamsmemes/image/upload/public/${imageName}.jpg`;
  const url = `https://www.teamsmemes.com/memes/public/${imageName}`;
