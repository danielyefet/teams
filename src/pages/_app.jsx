  ...
  return (
    <div className="container mx-auto p-4 max-w-screen-lg min-h-screen flex flex-col">
      <Head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-Z5RM6H25PY"
        />
        <script
      ...
      <header className="mb-4 p-2 flex content-center">
        <Link href="/">
          <a className="inline-flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 text-teams-purple mr-1"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
      ...
      {/* <SocialIcons className="mt-auto justify-end" /> */}
    </div>
  );
}
