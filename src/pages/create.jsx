  ...
  async function publish() {
    ...
    if (!slug)
      return setErrorMessage(
        "Something's preventing me from publishing. Firewall maybe? Sorry! 😬"
      );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Create your own Microsoft Teams conversation."
        />
      </Head>
      <Modal open={isNaming} onClose={handleModalClose}>
        <h2 className="mb-4 text-center text-gray-800 text-xl font-semibold">
          Name your creation...
        </h2>
        <form
          onSubmit={handleTitleConfirmation}
      ...
      <div className="max-w-md mx-auto">
        <h1 className="mb-8 text-center text-gray-800 text-xl font-semibold">
          Ready, steady, chat!
        </h1>
        <Header onSubmit={handleSubmit} />
        <div className="max-w-meme mx-auto">
          <Controls toggleIsOn={isDarkMode} onDarkModeToggle={setIsDarkMode} />
          <div className="relative overflow-hidden">
            <div
              className={`${
                isCreating
                  ? 'opacity-100 z-10'
                  : 'transition-all duration-700 opacity-0 z-0'
              } ${
                isDarkMode ? 'bg-gray-700' : 'bg-gray-300'
              } border-gray-400 border-2 border-dashed flex items-center justify-center absolute w-full h-full top-0 left-0`}
            >
              <svg
